...
import { initEditor } from "./entries.js?v=2.8.0";
import { initProfileHandlers } from "./profile.js?v=2.8.0";
import { initNotices } from "./notice.js?v=2.8.0";
import { initNotify } from "./notify.js?v=2.8.0";
import { initDday } from "./dday.js?v=2.8.0";
import { initSearchFilter, render } from "./render.js?v=2.8.0";
import { initCalendar } from "./calendar.js?v=2.8.0";
import { initChangelog } from "./changelog.js?v=2.8.0";
import { initAuth } from "./auth.js?v=2.8.0";
